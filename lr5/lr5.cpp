...
int main() {
    ...
    // Вывод количества объектов до создания (пункт 6 задания)
    ...
    // Добавление сеансов в кинотеатр (пункт 7 задания)
    ...
    // Вывод количества объектов после создания (пункт 8 задания)
